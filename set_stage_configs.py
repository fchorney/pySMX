...
####################################################
def make_new_config(
    player: int, old_config: SMXStageConfig, doubles: bool, debounce: int = 4000
) -> SMXStageConfig:
    ...
    # Sensor order is: Down, Up, Right, Left
...
def parse_args():
    ...
    parser.add_argument("--double", "-d", action="store_true")
    parser.add_argument("--debounce", "-b", default=4000, type=int)
