...
class SMXDeviceInfo(object):
    ...
    # TODO: We might potentially want to add the HID Device to this so we can just pass
    # around SMXDeviceInfo. Another alternative is to just have one of these objects in
    # the SMXHIDDevice object.
